...
SUBFOLDER="qwen2.5-1.5B-it-distillm2-1epoch"   # nếu model huggingface có subfolder chứa pytorch_model.bin, set tên subfolder này; nếu không có subfolder, set SUBFOLDER="" (empty string)
#MODEL_NAME="Qwen/Qwen2.5-Math-1.5B-Instruct"
TOKENIZER="VoCuc/nnm"   # nếu tokenizer cùng tên với model, set giống MODEL_NAME; nếu tokenizer khác tên hoặc có subfolder khác, set tên/tokenizer path ở đây
DEVICE="cuda"
DTYPE="bfloat16"
BATCH="16"           # 'auto' để lm-eval tự chỉnh; hoặc set 32, 16, ...
OUT_DIR="results/distillm2-1e"
