...
# Config
# ============================================================
MODEL_NAME="/home/hungpv/projects/NND/outputs/qwen2.5-math-distillm2-1epoch/checkpoint-2492"
...
TOKENIZER="/home/hungpv/projects/NND/outputs/qwen2.5-math-distillm2-1epoch/checkpoint-2492"   # nếu tokenizer cùng tên với model, set giống MODEL_NAME; nếu tokenizer khác tên hoặc có subfolder khác, set tên/tokenizer path ở đây
DEVICE="cuda"
DTYPE="bfloat16"
