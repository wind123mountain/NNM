...
(
    ...
    echo "[GPU 1] Start NNM-1e Llama 3.2 3B"
    CUDA_VISIBLE_DEVICES=1 bash ./scripts/train/llama3.2-3B-it/nnm_distillm_2.sh 2>&1 | tee outputs/logs/llama3.2_3b_it_nnm_distillm_2_1e.log
    
    echo "[GPU 1] Start NNM-1e Qwen 1.5B"
    CUDA_VISIBLE_DEVICES=1 bash ./scripts/train/qwen2.5-1.5B-it/nnm_distillm_2.sh 2>&1 | tee outputs/logs/nnm_distillm_2_qwen2.5_1.5b.log
